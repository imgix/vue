...
> ⚠️ You are viewing the Vue 2.x maintenance branch, and as such, this branch is not compatible with Vue 3. This branch will only contain bug fixes and security updates, all new features will be built for Vue 3. For Vue 3 support, please use the [`main` branch](https://github.com/imgix/vue/tree/main). 
